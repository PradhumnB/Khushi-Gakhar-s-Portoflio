...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="section-padding bg-primary" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-display font-bold text-primary-foreground mb-14">
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {experiences.map((exp, i) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-4 md:left-6 top-1 w-4 h-4 rounded-full bg-accent border-2 border-primary" />
