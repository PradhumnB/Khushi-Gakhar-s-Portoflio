            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {cat.skills.map((skill, si) => (
                  <motion.span
                    key={skill}
                    className="px-3 py-1.5 rounded-full bg-accent/10 text-accent-foreground font-body text-xs font-medium hover:bg-accent hover:text-accent-foreground transition-all duration-300 cursor-default"
